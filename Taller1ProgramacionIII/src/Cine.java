...
public class Cine {
    ...
    public int entradasDisponiblesP1() {
        int entradasDisponibles = 0;
        for (Asistente asistente : asistentes) {
            entradasDisponibles += asistente.getCantidad();
        }
        return 23-entradasDisponibles;
    }
    public int entradasDisponiblesP2() {
        int entradasDisponibles = 0;
        for (Asistente asistente : asistentes) {
            entradasDisponibles += asistente.getCantidad();
        }
